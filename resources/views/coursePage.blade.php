...
<form action="{{route('coursePage')}}" method="POST">
  ...
  <div class="container">
    ...
    <input type="text" placeholder="Enter syllabus" name="syllabus" required>

    <label for="duration"><b>Duration</b></label>
    <input type="time" placeholder="Enter Duration" name="duration" required>
